...
// Question #4
const first_side = document.querySelector('aside')
first_side.innerHTML =  `Welcome to <mark>our</mark> neighborhood! `
...
document.querySelector('#divs').textContent = `${divs.length}`
